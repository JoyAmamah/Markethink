...
const Footer = () => {
  return (
    <footer>
      ...
      <section className="bg-[#F6FBF9] px-4 py-8 sm:px-8 md:px-16 lg:px-32">
        <div className="flex flex-col items-center text-center lg:flex-row lg:items-start lg:text-left lg:justify-between gap-10">
